...
// 深圳到云南:$289
 ...
 // eslint-disable-next-line no-extra-boolean-cast
   return (Boolean((ele.children[0]?.text)))? (<D3Graph key={index} graphData={graphData(ele.children[0]?.text)} canvasConfig={canvasConfig}  />) : null
    }
)}   */}
   <D3Graph  graphData={graphData(editorContent)} canvasConfig={canvasConfig}  />
    </>
  );
}